...
# 镜像创建过程中执行的命令 可以多条
RUN buildDeps='gcc libc6 libsystemd-dev libusb-1.0-0-dev bzip2 make cmake ninja-build python3 python3-pip python3-venv curl vim tmux ssh net-tools iputils-ping git sudo' \
        && apt-get update \
